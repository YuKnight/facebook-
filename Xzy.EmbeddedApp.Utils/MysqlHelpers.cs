...
namespace Xzy.EmbeddedApp.Utils
{
    public abstract class MySqlHelpers
    {
        ...
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["MysqlConnString1"].ConnectionString;
        ...
        public static int Update(string sql, MySqlParameter[] param)
        {
            ...
            {
                //string errorInfo = "调用 public static int Update(string sql, MySqlParameter[] param)方法时发生错误:" + ex.Message;
