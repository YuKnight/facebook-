...
namespace Wx.Qunkong360.Wpf
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            SocketServer.Init();
            EventAggregatorManager.Instance.Initialize();
        }
        ...
        private static void RemoveShortcut()
        {
            try
            {
                ...
                if (desktopDirectoryInfo.GetFiles("*.lnk")
                    .Any(file => file.Name == "Facebook群控.lnk"))
                {
        ...
        private static async Task<bool> CheckUpdate()
        {
            ...
            try
            {
                ...
                if (hasUpdate)
                {
                    ...
                    //var result = MessageDialogManager.ShowDialogAsync(updateMsg, "更新提示", MessageBoxButtons.YesNo);
