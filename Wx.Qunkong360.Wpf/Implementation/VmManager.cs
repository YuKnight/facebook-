...
using Wx.Qunkong360.Wpf.Abstract;

namespace Wx.Qunkong360.Wpf.Implementation
{
    public class VmManager : IVmManager
    {
        ...
        public Dictionary<int, VmModel> _vmModels;
        ...
        public int GetRunningCount()
        {
            ...
            {
                int index = VmIndexArray[_runningGroupIndex, i];
